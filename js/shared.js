...
function renderNav() {
  ...
  <nav class="sitenav">
    <div class="nav-in">
      <a href="index.html" class="logo" style="padding:8px 0">
        <img
          src="${LOGO_URL}"
          alt="Countryside Roofing Siding & Windows Inc."
          class="logo-img"
          style="height:52px;width:auto;display:block"
          onerror="this.onerror=null;this.style.display='none';this.insertAdjacentHTML('afterend','<div style=\'display:flex;align-items:center;gap:13px\'><div class=\'logo-ico\'><svg width=\'24\' height=\'24\' viewBox=\'0 0 24 24\' fill=\'none\' stroke=\'white\' stroke-width=\'2\'><path d=\'M3 9l9-7 9 7v11a2 2 0 01-2 2H5a2 2 0 01-2-2z\'/><polyline points=\'9 22 9 12 15 12 15 22\'/></svg></div><div><div class=\'logo-name\'>Countryside</div><div class=\'logo-sub\'>Roofing · Siding · Windows</div></div></div>')"
        />
      </a>
      <div class="nav-links">
        ${links}
...
function renderFooter() {
  ...
  <footer class="footer">
    <div class="footer-grid">
      <div>
        <a href="index.html" style="display:inline-block;margin-bottom:18px">
          <img
            src="${LOGO_URL}"
            alt="Countryside Roofing Siding & Windows Inc."
            style="height:52px;width:auto;filter:brightness(0) invert(1);opacity:.85"
